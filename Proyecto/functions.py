...
# Definición de la cantidad de caracteres en la interfaz
cant_caracter = 48
...
# Función para mostrar información sobre la alimentación recomendada
def al_recom():
    clear()
    try:
...
# Función para mostrar rutinas de ejercicios de baja intensidad
def baja_intensidad():
    clear()
    print('Elija la intensidada del ejercicio:\n[1] Baja\n[2] Media\n[3] Alta')
    opcion = int(input('<<<'))
...
# Función para el menú de selección de rutinas de ejercicios
def menu_selec():
    clear()
...
# Función para elegir música para hacer ejercicio
def musica_menu():
    while True:
        clear()
        print("="*cant_caracter)
...
# Función para el menú de gimnasio
def menu_gym():
    while True:
        clear()
        print("="*cant_caracter)
